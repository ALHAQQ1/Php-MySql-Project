function CheckAndSend () {
  ...
  if (car_seller_name.value.lenght < 3) {
    car_seller_name.focus()
    alert('Please Enter Car Seller Name')
    return
  }
  console.log(car_seller_phone.value.lenght)
